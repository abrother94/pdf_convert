...
#if !defined(ME_GEM_INTERWORKING_TERMINATION_POINT_INCLUDE_HPP)
#define  ME_GEM_INTERWORKING_TERMINATION_POINT_INCLUDE_HPP
...
class ME_GEM_interworking_termination_point : public ME_S 
{
    public:
        ME_GEM_interworking_termination_point();
        ME_GEM_interworking_termination_point(int class_id,int instance_id, Json::Value me_s);
